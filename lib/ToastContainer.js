...
const TOAST_MAX_WIDTH = 0.9; // 原比例是0.8 现在改写为0.9
...
let styles = StyleSheet.create({
    ...
    containerStyle: {
        ...
        opacity: 0.85,
        borderRadius: 5,
        // marginHorizontal: WINDOW_WIDTH * ((1 - TOAST_MAX_WIDTH) / 2), // 将其改写为一个属性
        justifyContent: 'center',
        alignItems: 'center',
    },
    shadowStyle: {
...
class ToastContainer extends Component {
    ...
    static propTypes = {
        ...
        containerMarginHorizontal: PropTypes.number, // 容器占屏幕宽度的比例
    ...
    static defaultProps = {
        ...
        delay: 0,
        hideOnPress: false,
        containerMarginHorizontal: TOAST_MAX_WIDTH,
    };
                ...
                <Animated.View
                    style={[
                        ...
                        props.backgroundColor && {backgroundColor: props.backgroundColor},
                        {
                            ...
                            marginHorizontal: WINDOW_WIDTH * ((1 - props.containerMarginHorizontal) / 2)
                        },
